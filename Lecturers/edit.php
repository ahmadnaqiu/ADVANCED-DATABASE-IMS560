        ...
        <div class="form-wrapper">
            ...
            <div class="form-header-card">
                <div>
                    ...
                    <h3 class="page-title">Edit Lecturer: <?= h($lecturer->name) ?></h3>
                </div>
            ...
            <div class="main-form-card">
                ...
                <fieldset class="clean-fieldset">
                    ...
                    <div class="form-group">
                        <?= $this->Form->control('email', [
                            ...
                            'placeholder' => 'updated.email@university.edu.my',
                        ]) ?>
                    </div>
                ...
                <div class="form-action-footer">
                    <?= $this->Form->postLink(
                        ...
                        [
                            'confirm' => __('Are you sure you want to delete {0}?', $lecturer->name),
                            'class' => 'delete-btn'
                        ]
                    ) ?>
                    
                    <?= $this->Form->button(__('Update Record'), ['class' => 'submit-btn']) ?>
                </div>
                <?= $this->Form->end() ?>
            </div>
